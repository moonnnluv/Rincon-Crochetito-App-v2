package com.example.rincon_crochetitov2.Administrador.Orden
...
import com.example.rincon_crochetitov2.Adaptadores.AdaptadorProductoOrden
import com.example.rincon_crochetitov2.Constantes
import com.example.rincon_crochetitov2.Modelos.ModeloProductoOrden
import com.example.rincon_crochetitov2.R
import com.example.rincon_crochetitov2.databinding.ActivityDetalleOrdenAactivityBinding
...
class DetalleOrdenAActivity : AppCompatActivity() {

    private lateinit var binding : ActivityDetalleOrdenAactivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDetalleOrdenAactivityBinding.inflate(layoutInflater)
        ...
        ref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                try {
                    ...
                    Glide.with(this@DetalleOrdenAActivity)
                        .load(imagen)
    ...
    private fun productosOrden(){
        ...
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                productoOrdenAdaptador = AdaptadorProductoOrden(this@DetalleOrdenAActivity, productosArrayList)
        ...
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (estadoOrden.equals("Solicitud recibida")){
                    binding.estadoOrdenD.setTextColor(ContextCompat.getColor(this@DetalleOrdenAActivity, R.color.azul_marino_oscuro))
                }else if (estadoOrden.equals("En preparación")){
                    binding.estadoOrdenD.setTextColor(ContextCompat.getColor(this@DetalleOrdenAActivity, R.color.naranja))
                }else if (estadoOrden.equals("Entregado")){
                    binding.estadoOrdenD.setTextColor(ContextCompat.getColor(this@DetalleOrdenAActivity, R.color.verde_oscuro2))
                }else if (estadoOrden.equals("Cancelado")){
                    binding.estadoOrdenD.setTextColor(ContextCompat.getColor(this@DetalleOrdenAActivity, R.color.rojo))
                }
