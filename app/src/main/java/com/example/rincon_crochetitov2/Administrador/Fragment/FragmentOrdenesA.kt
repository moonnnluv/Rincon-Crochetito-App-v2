...
import com.example.rincon_crochetitov2.Adaptadores.AdaptadorOrdenCompraA
import com.example.rincon_crochetitov2.Modelos.ModeloOrdenCompra
import com.example.rincon_crochetitov2.databinding.FragmentOrdenesABinding
...
class FragmentOrdenesA : Fragment() {
    ...
    private lateinit var binding : FragmentOrdenesABinding
    private lateinit var mContext : Context

    private lateinit var ordenesArrayList : ArrayList<ModeloOrdenCompra>
    private lateinit var ordenAdaptador : AdaptadorOrdenCompraA
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentOrdenesABinding.inflate(inflater, container , false)
        return binding.root
    }
        ...
        ref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()){
                    ...
                    ordenAdaptador = AdaptadorOrdenCompraA(mContext , ordenesArrayList)
