...
import com.example.rincon_crochetitov2.Adaptadores.AdaptadorImagenSeleccionada
import com.example.rincon_crochetitov2.Constantes
import com.example.rincon_crochetitov2.Modelos.ModeloCategoria
import com.example.rincon_crochetitov2.Modelos.ModeloImagenSeleccionada
import com.example.rincon_crochetitov2.Administrador.MainActivityAdmin
import com.example.rincon_crochetitov2.databinding.ActivityAgregarProductoBinding
            ...
            if (!modeloImagenSel.deInternet){
                ...
                storageRef.putFile(modeloImagenSel.imagenUri!!)
                    .addOnSuccessListener {taskSnapshot->
                        ...
                        if (Edicion){
                            progressDialog.dismiss()
                            val intent = Intent(this@AgregarProductoActivity, MainActivityAdmin::class.java)
