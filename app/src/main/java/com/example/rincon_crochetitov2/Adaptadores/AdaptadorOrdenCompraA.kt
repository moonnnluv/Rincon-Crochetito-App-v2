...
import com.example.rincon_crochetitov2.Administrador.Orden.DetalleOrdenAActivity
import com.example.rincon_crochetitov2.databinding.ItemOrdenCompraBinding

class AdaptadorOrdenCompraA : RecyclerView.Adapter<AdaptadorOrdenCompraA.HolderOrdenCompra>{
    ...
    override fun onBindViewHolder(holder: HolderOrdenCompra, position: Int) {
        ...
        holder.ibSiguiente.setOnClickListener {
            val intent = Intent(mContext, DetalleOrdenAActivity::class.java)
